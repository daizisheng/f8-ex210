...
all: simulate_count divtest make_knight dynaham_modp_dumpT dynahamp_modp_dumpT
...
clean:
	rm -f simulate_count divtest make_knight dynaham_modp_dumpT dynahamp_modp_dumpT
